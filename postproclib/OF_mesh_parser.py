...
from .OF_field_parser import parse_internal_field, is_binary_format
...
class FoamMesh(object):
    ...
    @classmethod
    def parse_cellProcAddressing_content(cls, content, is_binary, skip=10):
        """
        parse cellProcAddressing from content
        :param content: file contents
        :param is_binary: binary format or not
        :param skip: skip lines
        :return: points coordinates as numpy.array
